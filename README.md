...
| 2 | **About** | [`about.html`](about.html) | Founder profile featuring authentic executive portrait (`images/afaq-portrait.jpg`), 5-phase architectural development milestones, platform advisory philosophy, responsive metrics, and corporate values. |
| 3 | **Services** | [`services.html`](services.html) | 8 dedicated advisory verticals (Property Acquisition, Investment Advisory, Property Selling, Portfolio Management, Commercial Assets, Development Advisory, Asset Management, Market Intelligence) and 4-phase client journey. |
...
| 5 | **Property Detail** | [`property-detail.html`](property-detail.html) | Dynamic slug-based loader (`?slug=...`), multi-angle gallery carousel, custom fullscreen image lightbox with arrow & ESC controls, interactive Schedule Viewing modal, WhatsApp concierge dispatch, and direct contact options. |
| 6 | **Team** | [`team.html`](team.html) | Editorial executive showcase for Afaq Ahmad (Founder & CEO) with authentic portrait, direct action CTAs (WhatsApp, LinkedIn, Call, Email), and 5 specialist advisory practice profiles. |
...
| 8 | **Testimonials** | [`testimonials.html`](testimonials.html) | Curated advisory perspectives strip (12 curated listings, 4 prime categories, 100% discretion record), sample international client case scenarios, and fiduciary privacy guarantee. |
